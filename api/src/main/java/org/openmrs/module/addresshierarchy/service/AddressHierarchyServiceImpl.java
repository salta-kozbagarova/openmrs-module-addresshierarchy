...
public class AddressHierarchyServiceImpl implements AddressHierarchyService {
	...
	public void deleteNonHierarchicalAddressEntriesByLevel(AddressHierarchyLevel level) {
		dao.deleteNonHierarchicalAddressEntriesByLevel(level);
		resetFullAddressCache();
	}
	...
	@Transactional
	public AddressHierarchyLevel addNonHierarchicalAddressLevel() {
		AddressHierarchyLevel newLevel = new AddressHierarchyLevel();
		newLevel.setParent(null);
		newLevel.setNonHierarchical(true);
		// need to call the service method through the context to take care of AOP
		Context.getService(AddressHierarchyService.class).saveAddressHierarchyLevel(newLevel);
		return newLevel;
	}
	...
	public List<AddressHierarchyLevel> getNonHierarchicalAddressLevels() {
		return dao.getNonHierarchicalAddressLevels();
	}
