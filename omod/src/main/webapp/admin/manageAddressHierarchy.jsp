...
<div><b class="boxHeader"><spring:message code="addresshierarchy.admin.uploadNonHierarchicalAddress" /></b>

<form id="uploadNonHierarchicalAddress" action="uploadNonHierarchicalAddress.form" method="post" enctype="multipart/form-data">
...
<tr>
	<td class="tableCell" style="font-weight:bold"><nobr><spring:message code="addresshierarchy.admin.level" />:</nobr></td>
	<td class="tableCell">
		<select name="levelId">
			<option value=""></option>
			<c:forEach var="level" items="${nonHierarchicalLevels}">
